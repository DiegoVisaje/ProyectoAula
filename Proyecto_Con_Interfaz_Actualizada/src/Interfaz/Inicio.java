...
public class Inicio extends javax.swing.JFrame {
    ...
    public Inicio() {
        ...
        this.jPanelExamen.setVisible(false);
    ...
    private void initComponents() {
        ...
        Escritorio.add(jLabelFondoPrincipal, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1780, 710));
        ...
        jPanel1MenuPrincipal.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, 180, 120));
        ...
        jPanel1MenuPrincipal.add(botonSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 0, -1, -1));
        ...
        jPanelMenuEstudiante2.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 180, 110));
        ...
        jPanel1MenuPrincipal.add(jPanelExamen, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 320, 220, -1));

        jPanelPrincipalBienvenida.add(jPanel1MenuPrincipal, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 710));
    ...
    private void jPanelBotonEstudiante1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelBotonEstudiante1MouseClicked
        this. jPanel1MenuPrincipal.setVisible(true);
          this.jPanelExamen.setVisible(true);
      /*  
        RegistrarProyecto a = new RegistrarProyecto();
        Escritorio.add(a);
        a.show();
        */
