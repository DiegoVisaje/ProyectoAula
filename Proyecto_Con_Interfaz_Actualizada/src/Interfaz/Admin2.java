...
public class Admin2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanelEliminarUsuario.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelEliminarUsuarioMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                jPanelEliminarUsuarioMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                jPanelEliminarUsuarioMouseExited(evt);
            }
        });
        jPanelEliminarUsuario.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
    ...
    private void jPanelEliminarUsuarioMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelEliminarUsuarioMouseExited
